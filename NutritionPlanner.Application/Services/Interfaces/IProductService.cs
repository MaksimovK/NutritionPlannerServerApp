...
namespace NutritionPlanner.Application.Services.Interfaces
{
    ...
    {
        Task<List<Product>> GetPaginatedProductsAsync(int page, int size, Guid? userId, Role userRole);
        ...
        Task<List<Product>> GetProductsByNameAsync(string name, Guid? userId, Role userRole);
