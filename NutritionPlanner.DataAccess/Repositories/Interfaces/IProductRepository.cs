...
namespace NutritionPlanner.DataAccess.Repositories.Interfaces
{
    ...
    {
        Task<List<ProductEntity>> GetPaginatedAsync(int page, int size, Guid? userId, Role userRole, ProductFilter filter = null);
        ...
        Task<List<ProductEntity>> GetByNameAsync(string name, Guid? userId, Role userRole, ProductFilter filter = null);
